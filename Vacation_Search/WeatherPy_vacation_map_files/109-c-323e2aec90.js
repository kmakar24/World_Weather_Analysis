(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[109],{"+Gzo":function(e,t,a){"use strict"
...
var h=function(e){Object(o["a"])(a,e)
var t=Object(s["a"])(a)
function a(){Object(i["a"])(this,a)
return t.apply(this,arguments)}Object(r["a"])(a,[{key:"render",value:function(){return c.a.createElement(d["a"],Object.assign({},this.props,{name:"IconDocument",viewBox:"0 0 1920 1920",bidirectional:true}),u)}}])
a.displayName="IconDocumentLine"
return a}(l["Component"])
h.glyphName="document"
h.variant="Line"
h.propTypes=Object(n["a"])({},d["a"].propTypes)},"+Pml":function(e,t,a){"use strict"
a.d(t,"a",(function(){return h}))
var n=a("VTBJ")
var i=a("1OyB")
var r=a("vuIU")
...
var t=Object(s["a"])(a)
function a(){Object(i["a"])(this,a)
return t.apply(this,arguments)}Object(r["a"])(a,[{key:"render",value:function(){return c.a.createElement(d["a"],Object.assign({},this.props,{name:"IconFolder",viewBox:"0 0 1920 1920",bidirectional:true}),u)}}])
a.displayName="IconFolderLine"
return a}(l["Component"])
h.glyphName="folder"
h.variant="Line"
h.propTypes=Object(n["a"])({},d["a"].propTypes)},"6ohZ":function(e,t,a){"use strict"
a.d(t,"a",(function(){return h}))
var n=a("RtDj")
var i=a("q1tI")
var r=a.n(i)
...
var l=a("HGxv")
var c=a("Dibh")
const d=Object(l["useScope"])("modal")
function u(){return document.getElementById("flash_screenreader_holder")}function h({label:e,closeButtonLabel:t,onDismiss:a,children:i,...l}){return r.a.createElement(c["a"],Object.assign({liveRegion:u},l,{label:e,onDismiss:a}),Object(n["a"])(c["a"].Header,{},void 0,Object(n["a"])(o["a"],{"data-testid":"instui-modal-close",placement:"end",offset:"medium",onClick:a,screenReaderLabel:t||d.t("Close")}),Object(n["a"])(s["a"],{},void 0,e)),i)}["Header","Body","Footer"].forEach(e=>h[e]=c["a"][e])
h.defaultProps={closeButtonLabel:void 0}},Ce78J:function(e,t,a){"use strict"
var n=a("ouhR")
var i=a.n(n)
var r=a("Y/W1")
var o=a.n(r)
var s=a("JiFB")
var l=a("ik22")
function c(e,t,a){const n={...a}
e.forEach(e=>{const i=t[e]
const r=a[e]
Array.isArray(i)&&Array.isArray(r)&&(n[e]=[...new Set(i.concat(r))])})
return n}function d(e,t,a,n,i){const r=new s["a"](i,l["a"],e,t)
const o={...r.defaultConfig()}
return{...o,...c(a.optionsToMerge||[],o,a.tinyOptions)}}var u=d
var h=a("FNQM")
...
var b=a("stQK")
var _=a("TiZd")
const C={loadingPromise:null,preload(e){(window.requestIdleCallback||window.setTimeout)(()=>this.loadRCE(e))},loadOnTarget(e,t,a){const n=this.getTargetTextarea(e)
const i=this.getRenderingTarget(n,t.getRenderingTarget)
const r=this.createRCEProps(n,t)
this.loadRCE(e=>{e.renderIntoDiv(i,r,e=>{e.tinymceOn("init",()=>a(n,g.wrapEditor(e)))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){return Promise.all([a.e(2),a.e(3),a.e(5),a.e(6),a.e(7),a.e(10),a.e(12),a.e(14),a.e(15),a.e(18),a.e(23),a.e(30),a.e(3750)]).then(a.bind(null,"j/Fk")).then(e=>{this.RCE=e
Object(h["a"])()
return e}).then(()=>{this.loadingCallbacks.forEach(e=>e(this.RCE))
this.loadingCallbacks=[]
e(this.RCE)})},getTargetTextarea:e=>"textarea"===i()(e).get(0).type?i()(e).get(0):i()(e).find("textarea").get(0),getRenderingTarget(e,t){let a
a="undefined"===typeof t?i()(e).parent().get(0):t(e)
i()(a).addClass("ic-RichContentEditor")
return a},_attrsToMirror(e){const t=["name"]
const a=o.a.reduce(e.attributes,(e,t)=>{e[t.name]=t.value
return e},{})
return o.a.pick(a,t)},createRCEProps(e,t){var a,n
...
return{defaultContent:e.value||t.defaultContent,editorOptions:u.bind(null,i,e.id,t,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:t.onFocus,onBlur:t.onBlur,textareaClassName:e.className,textareaId:e.id,trayProps:Object(v["a"])(),languages:s,liveRegion:()=>document.getElementById("flash_screenreader_holder"),ltiTools:null===(a=window.INST)||void 0===a?void 0:a.editorButtons,autosave:t.autosave||l,instRecordDisabled:ENV.RICH_CONTENT_INST_RECORD_TAB_DISABLED,maxInitRenderedRCEs:t.maxInitRenderedRCEs,highContrastCSS:null===(n=window.ENV)||void 0===n?void 0:n.url_for_high_contrast_tinymce_editor_css,use_rce_buttons_and_icons:Object(_["b"])(_["a"].ButtonsAndIcons,window.ENV)}}}
var y=C
var w=a("eodz")
function x(e,t,a){e.css("display","none")
const n=t.onFocus
t.onFocus=(...e)=>{n instanceof Function&&n(...e)}
y.loadOnTarget(e,t,(t,n)=>{const r=S(e)
const o=I(i()(t))
o.data("remoteEditor",n)
r.trigger(w["a"],n)
a&&a(n)})}function E(e){const t=S(e)
const a=t.attr("id")
const n="tinymce-parent-of-"+a
if(t.parent().attr("id")!==n)return t.wrap(`<div id='${n}' style='visibility: hidden'></div>`)}function k(){i()(".mce-resizehandle").attr("aria-hidden",true)}let T=0
function L(){return"random_editor_id_"+T++}function N(e){const t=i()(e)
const a="attr"in t?t.attr("id"):t.id
a&&""!=a||t.attr("id",L())}function I(e){const t=S(e)
const a=t.attr("id")
if(!a||""==a)return t
const n=i()("#"+a)
if(n.length<=0)return t
return n}const O={preloadRemoteModule:(e=(()=>{}))=>y.preload(e),loadNewEditor(e,t={},a){let n=S(e)
...
E(n)}x(n,t,r)
k()},callOnRCE(e,t,...a){let n=S(e)
n=this.freshNode(n)
return Object(w["d"])(n,t,...a)},destroyRCE(e){let t=S(e)
t=this.freshNode(t)
Object(w["b"])(t)},closeRCE(e){this.callOnRCE(e,"RCEClosed")},activateRCE(e){let t=S(e)
t=this.freshNode(t)
Object(w["c"])(t)},freshNode:I,ensureID:N,node2jquery:S}
function S(e){return e&&e.length?e:i()(e)}t["a"]=O},E7jo:function(e,t,a){"use strict"
var n=a("ouhR")
var i=a.n(n)
a("MIhX")
a("dJId")
...
var n=(e.positionAbs||e.position.absolute).left,r=n+e.helperProportions.width,o=(e.positionAbs||e.position.absolute).top,s=o+e.helperProportions.height
var l=t.offset.left,c=l+t.proportions.width,d=t.offset.top,u=d+t.proportions.height
switch(a){case"fit":return l<=n&&r<=c&&d<=o&&s<=u
case"intersect":return l<n+e.helperProportions.width/2&&r-e.helperProportions.width/2<c&&d<o+e.helperProportions.height/2&&s-e.helperProportions.height/2<u
case"pointer":var h=(e.positionAbs||e.position.absolute).left+(e.clickOffset||e.offset.click).left,f=(e.positionAbs||e.position.absolute).top+(e.clickOffset||e.offset.click).top,p=i.a.ui.isOver(f,h,d,l,t.proportions.height,t.proportions.width)
return p
case"touch":return(o>=d&&o<=u||s>=d&&s<=u||o<d&&s>u)&&(n>=l&&n<=c||r>=l&&r<=c||n<l&&r>c)
...
var n=t?t.type:null
var r=(e.currentItem||e.element).find(":data(droppable)").andSelf()
e:for(var o=0;o<a.length;o++){if(a[o].options.disabled||e&&!a[o].accept.call(a[o].element[0],e.currentItem||e.element))continue
for(var s=0;s<r.length;s++)if(r[s]==a[o].element[0]){a[o].proportions.height=0
continue e}a[o].visible="none"!=a[o].element.css("display")
if(!a[o].visible)continue
"mousedown"==n&&a[o]._activate.call(a[o],t)
a[o].offset=a[o].element.offset()
a[o].proportions={width:a[o].element[0].offsetWidth,height:a[o].element[0].offsetHeight}}},drop:function(e,t){var a=false
...
if(o.length){r=i.a.data(o[0],"droppable")
r.greedyChild="isover"==n?1:0}}if(r&&"isover"==n){r["isover"]=0
r["isout"]=1
r._out.call(r,t)}this[n]=1
this["isout"==n?"isover":"isout"]=0
this["isover"==n?"_over":"_out"].call(this,t)
if(r&&"isout"==n){r["isout"]=0
r["isover"]=1
r._over.call(r,t)}}))},dragStop:function(e,t){e.element.parentsUntil("body").unbind("scroll.droppable")
...
t["a"]=n},FNQM:function(e,t,a){"use strict"
...
var c={buttonConfig(e,t){const a={title:e.name,classes:"widget btn instructure_external_tool_button"}
a.id=e.id
...
a.image=e.icon_url
return a},showHideButtons(e){const t=s.t("Apps")
const a=e.$(e.editorContainer.querySelector(`.tox-tbtn--select[aria-label="${t}"]`))
const n=e.$(e.editorContainer.querySelector(`.tox-tbtn[aria-label="${t}"]`))
a.attr("aria-hidden","false")
n.attr("aria-hidden","true")},updateMRUList(e){let t
try{var a
t=JSON.parse((null===(a=window.localStorage)||void 0===a?void 0:a.getItem("ltimru"))||"[]")}catch(e){console.log("Found bad LTI MRU data",e.message)}finally{Array.isArray(t)||(t=[])}try{if(!t.includes(e)){var n
t.unshift(e)
t.splice(l,t.length)
null===(n=window.localStorage)||void 0===n||n.setItem("ltimru",JSON.stringify(t))}}catch(e){console.log("Cannot save LTI MRU list",e.message)}}}
var d=a("dDTa")
a("q1tI")
var u=a("i8i4")
var h=a.n(u)
const f=Object(i["useScope"])("ExternalToolsPlugin")
const p={init(e,t,i){if(!i||!i.editorButtons||!i.editorButtons.length)return
let r={open:(...e)=>setTimeout(()=>r.open(...e),50)}
Promise.all([a.e(2),a.e(3),a.e(6),a.e(13),a.e(19),a.e(4139)]).then(a.bind(null,"PrO8")).then(({default:t})=>{const a=document.createElement("div")
document.body.appendChild(a)
h.a.render(Object(n["a"])(t,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(d["a"])(),resourceSelectionUrl:o()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),a,(function(){r=this}))})
const s=[]
for(let t=0;i.editorButtons&&t<i.editorButtons.length;t++){const a=i.editorButtons[t]
const n=()=>r.open(a)
s.push(c.buttonConfig(a,e))
e.addCommand("instructureExternalButton"+a.id,n)}if(s.length){v(e,s)
b(e,s)
g(e,s)}}}
...
t.icon="lti_tool_"+t.id}t.iconSVG&&e.ui.registry.addIcon(t.icon,t.iconSVG)}function g(e,t){t.length&&e.ui.registry.addNestedMenuItem("lti_tools_menuitem",{text:f.t("Apps"),icon:"lti",getSubmenuItems:()=>_(e,t)})}function v(e,t){t.forEach(t=>{if(!t.favorite)return
m(e,t)
e.ui.registry.addButton("instructure_external_button_"+t.id,{onAction:t.onAction,tooltip:t.title,icon:t.icon,title:t.title})})}function b(e,t){const a=f.t("Apps")
e.ui.registry.addMenuButton("lti_mru_button",{tooltip:a,icon:"lti",fetch(a){a(_(e,t))},onSetup(t){c.showHideButtons(e)}})}function _(e,t){const a=[]
try{const n=JSON.parse(window.localStorage.getItem("ltimru"))
if(n&&Array.isArray(n)&&n.length){const i=t.filter(e=>n.includes(e.id))
i.forEach(t=>{m(e,t)
t.menuItem||(t.menuItem={type:"menuitem",text:t.title,icon:t.icon,onAction:t.onAction})
a.push(t.menuItem)})
a.sort((e,t)=>e.text.localeCompare(t.text))}}catch(e){console.log("Failed building mru menu",e.message)}finally{a.push({type:"menuitem",text:f.t("View All"),onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:t}})
document.dispatchEvent(e)}})}return a}var C=p
var y=a("ik22")
var w=a("uloQ")
...
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([a.e(0),a.e(9),a.e(4166)]).then(a.bind(null,"dIBj")).then(({default:a})=>{const n=new a(t.ed)
e.equationCB(n)}).catch(Object(w["c"])(x.t("Something went wrong loading the equation editor")))})
document.addEventListener("tinyRCE/initEquella",t=>{Promise.all([a.e(0),a.e(4279)]).then(a.bind(null,"IOhY")).then(({default:a})=>{a(t.detail.ed)
e.equellaCB()}).catch(Object(w["c"])(x.t("Something went wrong loading Equella")))})
document.addEventListener("tinyRCE/initExternalTools",t=>{C.init(t.detail.ed,t.detail.url,y["a"])
e.externalToolCB()})}},JiFB:function(e,t,a){"use strict"
a.d(t,"a",(function(){return r}))
var n=a("uYtQ")
var i=a("ErZx")
class r{constructor(e,t,a,n){this.baseURL=e.baseURL
this.extraButtons=t.editorButtons
this.instConfig=t
this.viewportWidth=a
this.idAttribute=n}defaultConfig(){var e
return{...i["a"],body_class:null!==(e=window.ENV.FEATURES)&&void 0!==e&&e.canvas_k6_theme||window.ENV.K5_SUBJECT_COURSE||window.ENV.K5_HOMEROOM_COURSE?"elementary-theme":"default-theme",selector:"#"+this.idAttribute,directionality:Object(n["b"])(),plugins:["instructure_equation"],content_css:window.ENV.url_to_what_gets_loaded_inside_the_tinymce_editor_css,style_formats:[{title:"Heading 2",format:"h2"},{title:"Heading 3",format:"h3"},{title:"Heading 4",format:"h4"},{title:"Heading 5",format:"h5"},{title:"Heading 6",format:"h6"}],init_instance_callback:e=>{$("#tinymce-parent-of-"+e.id).css("visibility","visible")},show_media_upload:!!INST.kalturaSettings&&!INST.kalturaSettings.hide_rte_button}}}},QLaP:function(e,t,a){"use strict"
var n=function(e,t,a,n,i,r,o,s){false
if(!e){var l
if(void 0===t)l=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.")
else{var c=[a,n,i,r,o,s]
var d=0
l=new Error(t.replace(/%s/g,(function(){return c[d++]})))
l.name="Invariant Violation"}l.framesToPop=1
throw l}}
e.exports=n},TiZd:function(e,t,a){"use strict"
a.d(t,"a",(function(){return n}))
a.d(t,"b",(function(){return i}))
let n;(function(e){e[e["ButtonsAndIcons"]=0]="ButtonsAndIcons"})(n||(n={}))
function i(e,t){switch(e){case n.ButtonsAndIcons:return r(t)
default:return false}}function r(e){var t,a
return!!(e.RICH_CONTENT_CAN_UPLOAD_FILES&&e.RICH_CONTENT_CAN_EDIT_FILES&&null!==(t=window.ENV)&&void 0!==t&&null!==(a=t.FEATURES)&&void 0!==a&&a.buttons_and_icons_root_account)}},TvTI:function(e,t,a){"use strict"
var n=a("ouhR")
var i=a.n(n)
var r=a("gI0r")
a("8JEM")
...
o.html(Object(r["a"])(a))}catch(e){}}}))}e.hrefValues&&e.data&&this.find("a,span[rel]").each((function(){let t,a,n,r=i()(this)
for(const o in e.hrefValues){if(!e.hrefValues.hasOwnProperty(o))continue
const s=e.hrefValues[o]
if(t=r.attr("href")){const a=i.a.replaceTags(t,s,encodeURIComponent(e.data[s]))
const n=r.text()===r.html()?r.text():null
if(t!==a){r.attr("href",a)
n&&r.text(n)}}(a=r.attr("rel"))&&r.attr("rel",i.a.replaceTags(a,s,e.data[s]));(n=r.attr("name"))&&r.attr("name",i.a.replaceTags(n,s,e.data[s]))}}))
...
n&&(a[e.dataValues[t]]=n)}if(e.htmlValues)for(t in e.htmlValues){const r=this.find("."+e.htmlValues[t].replace(/\[/g,"\\[").replace(/\]/g,"\\]")+":first")
n=null
...
a.find("li:not(.separator)").filter((function(){return!(i()(this).prev("li.separator").get(0)||i()(this).parents("ul.non-instTree").get(0))})).each((function(){i()(this).before(r)}))
...
const r=i()(this).parent("li")
const o=i()("div#instTree-drag")
i.a.browser.msie&&a.find("li.separator").removeClass("dd-hover")
i.a.browser.opera&&o.css("margin-top","10px")
if(r.is(".leaf")){o.addClass("leaf")
i.a.browser.msie&&o.css("background","#C3E1FF url("+n.opts.imgFolder+"leaf-drag.gif) left 3px no-repeat")}else r.is(".node")&&o.addClass("node")
r.prev("li.separator").addClass("alt").end().addClass("alt")
"function"===typeof n.opts.onDrag&&n.opts.onDrag(e,r)}))
a.find("li.separator").bind("dropover",(function(e,t){o=i()(this)}))
a.find("li.separator").bind("dropout",(e,t)=>{o=null})
a.find("span.text").bind("dragstop",(t,r)=>{let s=true
if(o){var l=a.find("li.alt:not(.separator):eq(0)")
const e=o.parents("li.node:eq(0)")
l.is(".node")&&e.is(".fixedLevel")&&(s=false)}if(o&&s){o.before(a.find("li.alt").remove().removeClass("alt"))
o=null
...
const r=a.find("span.active").get(0)
if(r){const a=i()(r).parents("li:first")
const o=i()(r).parents("li.node:first")
...
u=a.nextAll("li:not(.separator):first")
f=a.parent()
d=true}else if(a.is(".node")){h=a.children("ul").get(0)
if(h){i()(h).append(c)
u=i()(h).children("li:not(.separator):last")}else{a.append("<ul>"+c+"</ul>")
h=a.children("ul").get(0)
u=i()(h).children("li:not(.separator):last")}n.ExpandNode(e,a)
f=a
d=true}if(d){i()(r).removeClass("active")
f.find("input:text").focus().select().blur((function(){n.SaveInput(e,i()(this))}))}i.a.fn.instTree.InitInstTree(e)
"function"===typeof n.opts.onAddNode&&n.opts.onAddNode(u)}}}
i.a.fn.instTree.EditNode=function(e){a=i()(e)
const t=a.find("span.active").get(0)
if(t){const a=i()(t).parents("li:first")
i()(t).replaceWith('<span class="text">&nbsp;</span><input type="text" value="'+Object(r["a"])(i()(t).text())+'" />')
...
n.BindEvents=function(e){a.on("keydown",(function(t){const r=a.find('[aria-selected="true"]')
const o=i()("#file_list_container")
switch(t.which){case 38:t.preventDefault()
t.stopPropagation()
var s=n.FindNode(r,"up")
n.SelectNode(s)
o.scrollTop(n.FileScrollOffset(s,o))
break
case 40:t.preventDefault()
t.stopPropagation()
var l=n.FindNode(r,"down")
n.SelectNode(l)
o.scrollTop(n.FileScrollOffset(l,o))
break
case 37:t.preventDefault()
t.stopPropagation()
var c=r.attr("aria-expanded")
if(r.hasClass("node")&&"true"===c)n.CollapseNode(r)
else if("undefined"===typeof c||false===c||"false"===c){const e=r.parents(".node").eq(0)
n.SelectNode(e)
o.scrollTop(n.FileScrollOffset(e,o))}break
case 39:t.preventDefault()
t.stopPropagation()
c=r.attr("aria-expanded")
if(r.hasClass("node")&&"true"!==c)n.ExpandNode(e,r)
else if("true"===c){l=n.FindNode(r,"down")
n.SelectNode(l)
...
t.stopPropagation()
var u=i()('[role="treeitem"]:visible')
var h=u.last()
n.SelectNode(h)
o.scrollTop(n.FileScrollOffset(h,o))
break
case 36:t.preventDefault()
t.stopPropagation()
u=i()('[role="treeitem"]:visible')
var f=u.first()
n.SelectNode(f)
...
const r=i()(t.target)
let o
if(r.is("span.sign")){o=r.parents("li:eq(0)")
n.ToggleNode(e,o)}else if(r.is("span.text")){o=r.closest("li")
...
r.addClass("active")
o.hasClass("leaf")?o.addClass("active-leaf"):o.addClass("active-node")}n.opts.onClick.call(o,t,o)}else{n.opts.multi&&t.ctrlKey||a.find(".active").removeClass("active").end().find(".active-leaf").removeClass("active-leaf").end().find(".active-node").removeClass("active-node")
r.addClass("active")
...
let r=n
"up"==t?r--:r++
const o=r>=0?a.get(r):a.get(n)
const s=i()(o).data("indexPosition",r)
return s}
...
a.addClass("instTree")
i.a.fn.instTree.InitInstTree(n)}}))}},eVns:function(e,t,a){"use strict"
...
let[t,a]=Object(r["a"])(ENV.context_asset_string,false)
const n=ENV.current_user_id
const o={contextType:t,contextId:a,userId:n}
const s=ENV.RICH_CONTENT_CAN_UPLOAD_FILES
if(!s||"account"===t){a=n
t="user"}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:o,contextType:t,contextId:a,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:i(ENV.JWT),themeUrl:ENV.active_brand_config_json_url,canvasUrl:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN,features:{buttons_and_icons_cropper:null===(e=ENV.FEATURES)||void 0===e?void 0:e.buttons_and_icons_cropper}}}},xHhu:function(e,t,a){"use strict"
a.d(t,"a",(function(){return h}))
var n=a("VTBJ")
var i=a("1OyB")
var r=a("vuIU")
...
var t=Object(s["a"])(a)
function a(){Object(i["a"])(this,a)
return t.apply(this,arguments)}Object(r["a"])(a,[{key:"render",value:function(){return c.a.createElement(d["a"],Object.assign({},this.props,{name:"IconTrash",viewBox:"0 0 1920 1920"}),u)}}])
a.displayName="IconTrashLine"
return a}(l["Component"])
h.glyphName="trash"
h.variant="Line"
h.propTypes=Object(n["a"])({},d["a"].propTypes)}}])

//# sourceMappingURL=109-c-323e2aec90.js.map